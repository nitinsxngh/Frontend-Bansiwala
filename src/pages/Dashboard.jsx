...
export default function Dashboard() {
  ...
  const productColumns = [
    ...
    },
    {
      ...
      render: (status) => {
        ...
        const color = safeStatus === "available" ? "green" : "volcano";
  ...
  return (
    <DashboardLayout>
        <h1 style={{ color: "#22075e", fontSize: "55px", marginBottom: 30 }}>
          Welcome to Bansiwala Enterprices
       </h1>
       <h3 style={{ color: "#22075e", fontSize: "25px", marginBottom: 30 }}>
          Start Exploring From Left Menu
       </h3>
       <h3 style={{ color: "#22075e", fontSize: "22px", marginBottom: 30 }}>
          Manage Customer | Leads | Product | Product Categories | Admin | Bank
       </h3>
      {/*
      <Row gutter={[24, 24]}>
        <TopCard
            ...
            <Row className="pad10" gutter={[0, 0]}>
              <Col className="gutter-row" span={8}>
                <div className="pad15">
                  ...
                  <PreviewState tag={"Pending"} color={"blue"} value={5} />
